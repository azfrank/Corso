...
public class JsonDataRecipientManagmentCourseType extends JsonDataType {
    ...
    public Object nullSafeGet(final ResultSet rs, final String[] names, final SharedSessionContractImplementor session,
        ...
        try {
            ...
            return mapper.readValue(cellContent.getBytes("UTF-8"), new TypeReference<List<RecipientManagmentCourse>>() {});
